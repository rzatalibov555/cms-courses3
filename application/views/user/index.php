               ...
               <div class="row align-items-end">
                  <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-8">
                     <div class="section__title-wrapper mb-45">
                        <h2 class="section__title">Explore <br>Our <span class="yellow-bg">Popular <img src="<?php echo base_url('assets/user/'); ?>assets/img/shape/yellow-bg-2.png" alt="">  </span>Courses
                        </h2>
                     </div>
                  </div>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                     <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        ...
                        <div class="category__content">
                           <h4 class="category__title"><a href="course-details.php">Data Science</a></h4>
               ...
               <div class="row align-items-end">
                  <div class="col-xxl-5 col-xl-6 col-lg-6">
                     <div class="section__title-wrapper mb-60">
                        <h2 class="section__title">Find the Right<br>Online <span class="yellow-bg yellow-bg-big">Course<img src="<?php base_url("assets/user/"); ?>assets/img/shape/yellow-bg.png" alt=""></span> for you</h2>
         ...
         <section class="price__area pt-60 pb-130">
            <div class="container">
               <div class="row">
                  <div class="col-xxl-4 offset-xxl-4">
                     <div class="section__title-wrapper mb-60 text-center">
                        <h2 class="section__title">Simple <br> All Inclusive  <span class="yellow-bg yellow-bg-big">Pricing<img src="<?php echo base_url('assets/user/'); ?>assets/img/shape/yellow-bg.png" alt=""></span></h2>
                              ...
                              <div class="row">
                                 <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                                    <div class="price__item grey-bg mb-30 p-relative">
                                       ...
                                       <a href="contact.php" class="e-btn e-btn-4">Get Started</a>
                                    </div>
                                 </div>
                                 <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                                    <div class="price__item grey-bg mb-30 p-relative">
                                       ...
                                       <a href="contact.php" class="e-btn e-btn-border">Get Started</a>
                                    </div>
                                 </div>
                              </div>
                           </div>
