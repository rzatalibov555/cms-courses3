                     ...
                     <div class="course__wrapper">
                        ...
                        <div class="course__tab-2 mb-45">
                           <ul class="nav nav-tabs" id="courseTab" role="tablist">
                              ...
                              <li class="nav-item" role="presentation">
                                <button class="nav-link " id="curriculum-tab" data-bs-toggle="tab" data-bs-target="#curriculum" type="button" role="tab" aria-controls="curriculum" aria-selected="false"> <i class="icon_book_alt"></i> <span>Proqram</span> </button>
                              </li>
<!--                              <li class="nav-item" role="presentation">-->
...
<!--                                                  </div>-->
                                                  ...
                                                  <h5><a href="#"><?php echo $all_courses_item['i_c_name']; ?></a></h5>
                                                  <div class="course__sm-price">
                                                      <span><?php echo $all_courses_item['duration']; ?></span>
                                                  </div>
                                              </div>
                                          </div>
                                      </li>
